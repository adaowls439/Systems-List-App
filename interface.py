...
def create_main_window(config, data, current_name_index, hge):
    ...
    layout = [
        ...
        [sg.Text(data['system'][current_name_index], size=(22, 1), font=fontBold1, background_color='black', justification='center', key='-NAME-'),
        sg.Text(data['ly'][current_name_index], size=(7, 1), font=fontBold1, background_color='black', justification='left', key='-LY-')],
        ...
        [sg.Text(f'Iniciado com rota {hge}', size=(400, 1), font=fontBasic, justification='left',
    ...
    return sg.Window('Lista de Sistemas. by: adaowls439', layout,
                    element_justification='center', size=window_size, background_color=background, keep_on_top=True, finalize=True)
